-- oxygeneratorbig: block that gives breath at times while in radius, mod for minetest
-- minetest 0.4.17.1
-- (c) 2018 ManElevation
...
--dofile(minetest.get_modpath("oxygenerator").."/indrustial.lua")
...
drawtype = "mesh",
 ...
 --inventory_image = "oxygenerator.png",
   --wield_image = "oxygenerator.png",
   paramtype = "light",
   paramtype2 = "facedir",
